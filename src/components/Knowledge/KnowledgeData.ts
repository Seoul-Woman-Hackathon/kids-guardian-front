...
export const KNOWLEDGE_DATA: KnowledgeDataType[] = [
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1585366119957-e9730b6d0f60?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=871&q=80",
    detail: [
      "자동차가 다니는 길과 가까운 길로 걷지 않기 ",
      "친구와 장난치며 길에서 뛰지 않기 ",
      "자동차 뒤에서 놀지 않기",
  ...
  },
  {
    ...
    title: "안전한 도로 횡단 방법",
    subTitle: "안전한 도로 횡단 방법에 대해 알아볼까요?",
    img: "https://images.unsplash.com/photo-1534732806146-b3bf32171b48?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80",
    detail: [
      "자동차가 다니는 길과 가까운 길로 걷지 않기 ",
      "친구와 장난치며 길에서 뛰지 않기 ",
      "자동차 뒤에서 놀지 않기",
